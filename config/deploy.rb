...
set :application_name, 'vitrage_demo'
set :domain, 'codenohito.server' # vitrage-demo.codenohito.ru
set :deploy_to, '/home/dymio/www/vitrage_demo'
set :repository, 'git@github.com:dymio/vitrage-demo.git'
set :branch, 'master'
